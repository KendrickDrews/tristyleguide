<template>
  <div class="DMID-main">
      ...
      v-bind:showNav="{ 
        ...
        <ServiceRequests slot="bigIcon" fill="white" height="75px" width="75px"  class="svg-icon" />
      ...
      <div class="main-bodyContent">
        ...
        <div class="bodyContent">
          <div class="mainContent "> 
            <ul class="indent2x">
              <li>To submit a Essential Regulatory Documents Services request, complete the form below.</li>
